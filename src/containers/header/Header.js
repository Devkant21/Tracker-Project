  ...
  <div className="sp__header section__padding" id="home">
    <div className="sp__header-content">
      <h1 className="gradient__text">👋 
        ...
        <h3>All you need to learn Effectively, Efficiently, and Curiously</h3>
          <p2>Learning can be messy, SandPark is here to help!
          We have built the tools you need to manage all learnings at one place.</p2>
    </div>
